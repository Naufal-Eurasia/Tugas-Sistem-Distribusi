...
Buat file dengan nama berikut :
nama file server_week7
------------------------------------
...
```
lalu request berupa raw json
``` json
{"nama":"budi", "nim":"1234567","saldo":"347000",
"nominal_transaksi":"15000"}
 ```
lalu gunakan POST dengan url berikut :
```
...
<img width="1919" height="1076" alt="Screenshot 2025-11-05 145828" src="https://github.com/user-attachments/assets/57a8254a-2fc4-4a48-96b6-4851ae5d11d7" />
